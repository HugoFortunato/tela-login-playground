...
//Essa parte de comando diz que quando minha animação começar, irei passar um evento chamado down (olhar no CSS) porém no meu corpo body eu quero que minha barra de rolagem suma, ou seja, aciono o overflow="hidden".
